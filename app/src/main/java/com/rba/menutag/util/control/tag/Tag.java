...
public class Tag extends TextView implements View.OnClickListener {
    ...
    public void initTag(Context context, int index, String label, int selectedColor,
        ...
        if (selectedColor == -1) {
            selectedDrawable.setColorFilter(
                    new PorterDuffColorFilter(ContextCompat.getColor(context, R.color.colorAccent),
        ...
        if (selectedFontColor == -1) {
            this.selectedFontColor = ContextCompat.getColor(context, R.color.colorPrimary);
        }
        ...
        if (unselectedFontColor == -1) {
            this.unselectedFontColor = ContextCompat.getColor(context, R.color.colorAccent);
        }
    ...
    public static class TagBuilder {
        ...
        public Tag build(Context context) {
            Tag tag = (Tag) LayoutInflater.from(context).inflate(R.layout.tag, null);
            tag.initTag(context, index, label, selectedColor, selectedFontColor, unselectedColor,
                    unselectedFontColor);
